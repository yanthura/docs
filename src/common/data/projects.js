const projects = [
  {
    ...
    files: [
      { name: "Yanthura Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Yanthura Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Yanthura Logo.Zip", size: "2.02 MB", link: "#" },
